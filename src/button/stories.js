...
storiesOf('Actions/Button', module).add('Inline', () => (
  <Wrapper>
    <Separator>
      <Button intent={Button.intent.Inline} size={Button.size.Small}>
        Small Button
      </Button>
    </Separator>
    <Separator>
      <Button intent={Button.intent.Inline} size={Button.size.Normal}>
        Normal Button
      </Button>
    </Separator>
    <Separator>
      <Button intent={Button.intent.Inline} size={Button.size.Big}>
        Big Button
      </Button>
    </Separator>
    <Separator>
      <Button
        intent={Button.intent.Inline}
